...
st.write("upload your CSV and Excel files to convert formats and clean efficiently")
...
if files:
    for file in files:
        ...
        if st.button(f"Convert {file.name} as {format_choice}"):
            ...
            output.seek(0)
            st.download_button(f"Download file as {format_choice}", data=output, file_name=new_name, mime=mine)
        st.success("File converted and downloaded successfully🎉")        
